function G_createfigure(Y1)
%CREATEFIGURE(Y1)
%  Y1:  vector of plot y data

%  Auto-generated by MATLAB on 15-Oct-2022 13:22:41

% Create figure
figure1 = figure('NumberTitle','off','Name','G');
...
% Create plot
plot1 = plot(Y1,'DisplayName','data1');
...
% Plot the fit
fitLine1 = plot(xplot1,yplot1,'DisplayName','   4th degree',...
    'XLimInclude','off',...
    'Tag','4th degree',...
    'Parent',axes1,...
    'MarkerSize',6,...
